...
public class LoadNoSQL implements RequestHandler<Request, HashMap<String, Object>> {
    ...
    public HashMap<String, Object> handleRequest(Request request, Context context) {
        ...
        int startRecord = Integer.parseInt(request.getStartRecord());
        int endRecord = Integer.parseInt(request.getEndRecord());
        ...
        //MOVING LINE TO THE RECORD WE WANT TO READ FROM
        while (scanner.hasNext() && i < startRecord) {
        ...
        while (scanner.hasNext() && i <= endRecord) {
        ...
        logger.log("Time to load NoSQL " + elapsedTime);
        scanner.close();
